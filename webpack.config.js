...
// Agregamos el plugin de CssMinimizer y terszer
const CssMinimizerPlugin = require('css-minimizer-webpack-plugin');
const TerserPlugin = require('terser-webpack-plugin');
// Llamamos a la dependencia que maneja las variables de entorno
const Dotenv = require('dotenv-webpack')
// Invicamos el plugin que limpiara nuestro proyecto
...
module.exports = {
    ...
    plugins: [
        ...
        new Dotenv(),
        // Aniadimos el plugin cleanWebpackPlugin
        new CleanWebpackPlugin(),
    ],
    // Agregamos a los dos plugins para optimizar los archivos en una nueva seccion llamada optimization
    optimization: {
        minimize: true,
        minimizer: [
